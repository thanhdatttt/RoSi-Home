...
- o feature is implemented without team consensus and Sponsor approval.
...
- Mndatory PR cross-review (reviewer must be from a different domain)
...
**2. Deliverables and Milestones (The "What" and "When")**
- Decision before Week 10 (1 weeks before demo day).
