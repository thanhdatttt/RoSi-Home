  ...
  return (
    <MobileFrame>
      <View className="flex-1 flex-col items-center justify-center px-8 bg-background">
        <View className="h-20 w-20 rounded-3xl bg-[#5FD8A8] items-center justify-center shadow-lg shadow-[#5FD8A8]/60">
          <MailCheck size={36} color="#022A1A" />
        </View>
        ...
        <View className="mt-8 w-full gap-2">
          <Link href="/login" asChild>
            <PrimaryButton variant="mint">Back to sign in</PrimaryButton>
          </Link>
